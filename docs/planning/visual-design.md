...
[무작위 Dodge 궤적과 크게 축소된 강아지, Match Miss 동시 표현 전체 화면 v9](../design/concepts/neon-orbit-small-dog-fixed-hitbox-v9.png)
