...
[1U 구역 경계·물리 반사 Dodge 궤적과 작은 강아지, Match Miss 동시 표현 전체 화면 v10](../design/concepts/neon-orbit-thin-zone-margin-v10.png)
...
- v10은 `02:23.456`의 약 26개 중후반 점 밀도, 2U 강아지 표시 크기와 절반으로 줄인 1U 구역 경계를 함께 확인하는 시안이다. 점과 궤적은 흰색·회색만 사용한다.
...
- 평상시 구역 경계는 총 폭 1U, 중심선 양쪽 0.5U의 어두운 십자 마진으로 고정한다. 경계선 자체가 움직이지 않게 해 캐릭터 위치 판단을 돕는다. 십자 교차점에도 별도의 원, `+` 또는 장식 아이콘을 두지 않는다.
